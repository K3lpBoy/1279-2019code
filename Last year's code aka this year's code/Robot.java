...
public class Robot extends TimedRobot
{
   ...
   // CAN IDs
   private final int               FL_DRIVE_CAN_ID  = 4;
   private final int               FR_DRIVE_CAN_ID  = 7;
   private final int               RL_DRIVE_CAN_ID  = 5;
   private final int               RR_DRIVE_CAN_ID  = 8;

   private final int               L_CLAW_CAN_ID    = 1;
   private final int               R_CLAW_CAN_ID    = 2;
   private final int               CLAW_ARM_CAN_ID  = 3;

   private final int               AUTO_LDR_CAN_ID  = 6;

   private final int               ELEVATOR_CAN_ID  = 10;          // 9;

   private final int               CLIMBER_CAN_ID   = 9;           // 10;
